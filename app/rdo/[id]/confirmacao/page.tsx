    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-between">
      ...
      <main className="p-6 flex-1 flex flex-col items-center justify-center text-center space-y-6 max-w-sm mx-auto">
        ...
        <div className="animate-in zoom-in-50 duration-500 ease-out">
          <div className="w-20 h-20 rounded-full bg-green-50 border-4 border-green-200 flex items-center justify-center text-green-600 shadow-sm">
        ...
        {/* Card Resumo Final */}
        <Card className="w-full bg-white border border-gray-200 rounded-2xl p-5 text-left space-y-3 text-xs text-gray-700 shadow-sm">
          ...
          <div className="flex items-center gap-2 text-green-700 font-semibold pt-2 border-t border-gray-100">
        ...
        <div className="w-full bg-white border border-gray-200 rounded-2xl p-5 text-left space-y-3 shadow-sm">
